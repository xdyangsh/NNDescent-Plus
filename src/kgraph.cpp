...
#pragma omp parallel for
        ...
        {
            string path;
            path = string("./result/default/") + string("kgraph_data(") + data + string(")_L") + std::to_string(params.L) + string("_S") + std::to_string(params.S) + string("_R") + std::to_string(params.R) + string(".csv");
